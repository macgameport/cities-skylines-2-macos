...
| `VOID` | [The webhelper shim renders everything EXCEPT text — `--in-process-gpu` is what kills glyphs (2026-08-24 late)](docs/steam-ui-investigation.md#the-webhelper-shim-renders-everything-except-text---in-process-gpu-is-what-kills-glyphs-2026-08-24-late) |
...
| `VOID` | [The glyph loss is IN-PROCESS GPU itself, not `--in-process-gpu` — `--single-process` fails identically (2026-08-28)](docs/steam-ui-investigation.md#the-glyph-loss-is-in-process-gpu-itself-not---in-process-gpu---single-process-fails-identically-2026-08-28) |
...
| `SUPERSEDED` | [The glyph defect localised: Chromium has NO working GL at all on this engine (2026-08-29)](docs/steam-ui-investigation.md#the-glyph-defect-localised-chromium-has-no-working-gl-at-all-on-this-engine-2026-08-29) |
