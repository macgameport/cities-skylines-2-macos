> ## ⚠️ SUPERSEDED — HISTORICAL ONLY (archived 2026-08-22)
>
> **Do not follow this recipe.** It describes the **Wine 11 + DXVK + private-API MoltenVK** stack,
> which was real and did render CS2 — but it device-lost roughly **1 run in 8**, and the prefix it
> targets (`~/cs2-mac`) no longer exists on disk.
>
> It was superseded by **Wine 10 Sikarugir + D3DMetal**, which is stable and additionally solved the
> Paradox Mods download problem. See [`../README.md`](../README.md) and
> [`../docs/patch-inventory.md`](../docs/patch-inventory.md).
>
> Kept because the MoltenVK private-API finding is genuinely novel and may matter to anyone
> without a D3DMetal-capable Wine.
